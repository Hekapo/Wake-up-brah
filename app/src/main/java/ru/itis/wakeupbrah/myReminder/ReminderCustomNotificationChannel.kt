...
class ReminderCustomNotificationChannel {
    ...
    fun createChannel(context: Context?) {
        if (context != null) {
            ...
            val channel = NotificationChannel(
                ...
                context.getString(R.string.notification_channel_name1),
                importance
            ).apply {
                description = context.getString(R.string.notification_channel_desc1)
